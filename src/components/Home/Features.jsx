...
import {Disc2Icon, Zap} from 'lucide-react'
    ...
    <div id="features" className="flex flex-col items-center my-10 scroll-mt-12">
      ...
      <div className="flex flex-col md:flex-row items-center xl:-mt-10">
        ...
        >
          ...
          >
            <div
              className={`p-6 group-hover:bg-green-100 border border-transparent group-hover:border-green-300  flex gap-4 rounded-xl transition-colors ${
                !isHover ? "border-green-300 bg-green-100" : ""
              }`}
            >
              <svg
