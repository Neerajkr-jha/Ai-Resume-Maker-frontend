  ...
  const templates = [
    {
      ...
      name: "classic",
      preview:
        "A clean, Traditional resume format with clean sections and professional typography",
    },
    {
      id: "modern",
      name: "modern",
    ...
    },
    {
      id: "minimal",
      name: "minimal",
      preview: "Ultra clean design that puts your content front and centre",
    },
  ];
  return (
    <div className="relative">
      <button
        ...
        className="flex items-center gap-1 text-sm text-blue-600 bg-linear-to-br from-blue-50 to-blue-100 ring-blue-300 hover:ring transition-all px-3 py-2 rounded-1g"
      >
