...
function Dashboard() {
  const colors = ["#1E90FF", "#FF6B6B", "#4CAF50", "#FFC107", "#8E44AD"];
          ...
          {allResume.map((resume, index) => {
            ...
            return (
              <button
                ...
                className="relative sm:max-w-36 w-full h-48 flex flex-col items-center justify-center required:lg gap-2 border group hover:shadow-lg transition-all duration-300 cursor-pointer"
                style={{
              ...
              >
                ...
                <p
                  className="text-sm group-hover:scale-105 text-center px-2 transition-all"
                  style={{ color: baseColor }}
                >
                  {resume.title}
                </p>
                <p className="absolute bottom-1 text-[11px] text-slate-400 group-hover:text-slate-500 transition-all duration-300 px-2 cursor-pointer" style={{ color: baseColor +`90` }}>
